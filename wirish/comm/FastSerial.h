...
#define FSTXPIN0 	BOARD_USART1_TX_PIN
#define FSRXPIN0 	BOARD_USART1_RX_PIN

#define FSUSART1 	_USART2
#define FSTXPIN1 	BOARD_USART2_TX_PIN
#define FSRXPIN1 	BOARD_USART2_RX_PIN

#define FSUSART2 	_USART3
#define FSTXPIN2 	BOARD_USART3_TX_PIN
#define FSRXPIN2 	BOARD_USART3_RX_PIN

#if defined(STM32_HIGH_DENSITY)
#define FSUSART3 	_UART4
#define FSTXPIN3 	BOARD_UART4_TX_PIN
#define FSRXPIN3 	BOARD_UART4_RX_PIN

#define FSUSART4 	_UART5
#define FSTXPIN4 	BOARD_UART5_TX_PIN
#define FSRXPIN4 	BOARD_UART5_RX_PIN
#endif
...
#define FastSerialPort4(_portName)      FastSerialPort(_portName, 4)
#endif
...
#define FastSerialPort_Init4(_portName) FastSerialPort_Init(_portName, 4)
#endif
