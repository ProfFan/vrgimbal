...
#define AFIO_REMAP_USE_MAPR2            ((uint32_t)0x80000000)

typedef uint32_t afio_remap_peripheral;
...
extern void gpio_foreach(void (*fn)(gpio_dev*));
