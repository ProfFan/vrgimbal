...
static void spi_reconfigure(spi_dev *dev, uint8_t ismaster, uint16_t baudPrescaler, uint16_t bitorder, uint8_t mode) {
	...
	if (!ismaster)
	{
		...
		spi_irq_enable(dev, SPI_I2S_IT_RXNE | SPI_I2S_IT_RXNE | SPI_I2S_IT_ERR);
	}
