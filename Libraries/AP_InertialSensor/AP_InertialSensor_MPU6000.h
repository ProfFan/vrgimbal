...
public:
  ...
  AP_InertialSensor_MPU6000(HardwareSPI *spi_dev, uint8_t cs_pin, bool bCSActiveHigh, int interrupt_pin, FastSerial *ser_port);
...
private:
  ...
  static int16_t spi_transfer_16(void);
	...
	static boolean _cs_active_high;
	static uint8 _interrupt_pin;
