#ifndef APM_RC_MP32V3_h
#define APM_RC_MP32V3_h
...
//#define MINONWIDTH 1000
//#define MAXONWIDTH 2000
//#define MINOFFWIDTH 12000
//#define MAXOFFWIDTH 24000

//TEO 20140902
// PATCH FOR FAILSAFE AND FRSKY
#define MINONWIDTH 800
#define MAXONWIDTH 2100

//TEO 20140930
// PATCH FOR MicroBrani CH5 CH6 output a 490Hz
//#define MINOFFWIDTH 1000
#define MINOFFWIDTH 100
...
class APM_RC_MP32V3 : public APM_RC_Class
{
private:
  public:
	/// Constructor
  ...
  public:
	...
	void InitPPM(void);
	void InitDefaultPWM(char board);
  ...
  void disable_out(uint8_t);
	...
	void radio_mode_set(unsigned char value);
	unsigned char radio_mode_get(void);
